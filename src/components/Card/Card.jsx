...
export function Card({ max_tickets, name, place, price }) {
  return (
    <div className="group bg-white border-slate-200 border-2 rounded-3xl p-5 cursor-pointer">
      <img className="rounded-xl aspect-square object-cover" src={img} alt="test" />
      ...
      <div className="flex flex-col gap-4 pt-5">
        ...
        <span className="text-2xl text-primary">{(price/100).toFixed(0)}<span className="text-xs font-bold">.{(price/100).toFixed(2).slice(-2)}</span> €</span>
        ...
        <div className="flex justify-between items-start flex-wrap-reverse gap-3">
          ...
          <div className="flex flex-col gap-1 items-center">
            ...
            <div className="flex">
              <div className="w-10 px-3 py-1 text-xl text-primary border-slate-200 border-2 rounded-tl-full rounded-bl-full leading-none cursor-pointer hover:bg-primary hover:text-white hover:border-primary">-</div>
              <input
                min={0}
                max={max_tickets}
                defaultValue={1}
              ...
              />
              <div className="w-10 px-3 py-1 text-xl text-primary border-slate-200 border-2 rounded-tr-full rounded-br-full leading-none cursor-pointer hover:bg-primary hover:text-white hover:border-primary">+</div>
            </div>
          </div>
        </div>
      </div>
