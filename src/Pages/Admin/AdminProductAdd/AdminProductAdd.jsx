...
export function AdminProductAdd() {
    ...
    return <Section className="flex-col">
        ...
        <form className="w-full">
            ...
            <button type="submit" onClick={handleAdd} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Ajout un nouveau produit</button>
        </form>
    </Section>
