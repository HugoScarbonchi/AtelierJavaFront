          ...
          <div className="px-20">
            {cartDetailsList &&
              (<div>
                ...
                <table className="mt-10">
                  <thead>
                    <tr className="border-solid border-b-2 text-primary">
                      ...
                      <th className="uppercase text-lg text-center">
                        Quantité
                      </th>
                  ...
                  <tbody>
                    {cartDetailsList.map((detail, i) => {
                      ...
                      return (
                        <tr
                          key={i}
                          className="border-solid border-b-2 text-primary"
                        >
                    ...
                    <tr className="border-solid border-b-2 text-primary">
                      <td className="uppercase text-xl py-3 text-start font-bold">
                        Total
                      </td>
                      <td></td>
                ...
                <div>
                  <h2 className="font-bold text-3xl text-primary mt-10">
